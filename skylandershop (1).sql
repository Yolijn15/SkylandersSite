...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 11 jun 2021 om 13:08
...
(1, 'Fire', 'images/FireSymbol.jpg'),
(2, 'Water', 'images/WaterSymbol.jpg'),
(3, 'Air', 'images/AirSymbol.jpg'),
...
CREATE TABLE `skylanders` (
  ...
  `skylandersStats` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `skylanders` (`skylanderId`, `elementId`, `serieId`, `skylanderImage`, `skylanderName`, `skylanderDescription`, `skylandersStats`) VALUES
...
(58, 2, 3, 'Wash_Bucker.jpg', 'Wash Bucker', 'Unlike most pirates, Wash Buckler is kind-hearted and true. He was never comfortable with pirating.', ''),
...
(71, 10, 4, 'Short-Cut', 'Short Cut', 'Short Cut can be a perfectionist, but only because he loves what he does. He puts a lot of time and energy into creating each masterpiece.', ''),
...
(99, 6, 6, 'Aurora.jpg', 'Aurora', 'Aurora is a Light elemental Sensei in Skylanders: Imaginators. She is the niece of the great Portal Master Eon and trains Imaginators of the Swashbuckler Battle Class.', ''),
...
(103, 8, 6, 'Buckshot.jpg', 'Buckshot', 'Buckshot is cheerful and energetic, but apparently not exactly smart, as he failed classes and is unable to count his own Skylander stats.', ''),
...
(142, 3, 2, 'Jet-Vac.jpg', 'Jet-Vac', 'Noble and courageous, Jet-Vac always think of others before himself. Now a Skylander, he soars where even eagles never dare. In the Full Blast microcomic, he\'s shown to be a bit of a defeatist, thinking his worth as a fighter is lost without a weapon.\r\n\r\nIn Skylanders: Imaginators, Jet-Vac displays dedication in searching for what has been stolen from him, in his case, his lunch that was stored away within the Sky Fortress.', ''),
